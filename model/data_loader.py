...
# types == train，返回trainloader；否则返回devloader
def fetch_dataloader(types, params):
    ...
    # 对训练集进行random crops和水平翻转
    # augmentation是增强的意思
    if params.augmentation == "yes":
        # transforms.Compose串联多个图片变换的操作
        # RandomCrop剪裁，RandomHorizontalFlip随机水平翻转，ToTensor将PIL Image或者 ndarray 转换为tensor
        # Normalize标准化
